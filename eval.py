...
def eval_BME(pathin1, pathout2):
    ...
    if precision > 0 and recall > 0:
        f1 = 2.0 * (precision * recall) / (precision + recall)
    print("song true_num hit_num pred_num:", true_num, hit_num, pred_num)
...
if __name__ == "__main__":
    pathin1 = "predict_output/test_BME_out"
    pathin2 = "predict_outout/test_BME"
    eval_BME(pathin1, pathin2)
    eval_XYZ(pathin1, pathin2)
    eval_UVW(pathin1, pathin2)
    eval(pathin1, pathin2)
